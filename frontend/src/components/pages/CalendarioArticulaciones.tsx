...
interface CalendarEvent {
    ...
    borderColor: string;
    textColor: string;
    extendedProps: { record: ArticulacionRecord };
}
...
export default function CalendarioArticulaciones() {
    ...
    const [selected, setSelected] = useState<ArticulacionRecord | null>(null);
    ...
    useEffect(() => {
        const fetch = async () => {
            ...
            try {
                ...
                console.error('Error fetching articulaciones:', e);
            } finally {
                setLoading(false);
            }
        };
    ...
    const handleEventClick = (info: EventClickArg) => {
        setSelected(info.event.extendedProps.record as ArticulacionRecord);
    };
                ...
                <div className="max-w-7xl mx-auto w-full">
                    <div className="mb-6">
                        <h1 className="text-3xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                            ...
                            Calendario de Articulaciones
                        </h1>
                        <p className="text-zinc-500 mt-2">Visualice las articulaciones intersectoriales en el calendario.</p>
