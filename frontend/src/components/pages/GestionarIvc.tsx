...
import { RefreshCcw, Calendar, MapPin, Layers, CheckCircle, AlertCircle, Pencil, Trash2, X } from 'lucide-react';
            ...
            <main className="flex-1 flex flex-col overflow-y-auto bg-zinc-50/50 p-8">
                <div className="max-w-7xl mx-auto w-full">
                    ...
                    <div className="mb-6">
                        ...
                        <p className="text-zinc-500 mt-2">Listado de registros de Inspección, Vigilancia y Control.</p>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
                        <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[85vh] overflow-y-auto">
                            <div className="p-6 border-b border-zinc-200 flex justify-between items-center sticky top-0 bg-white z-10">
                                <div>
                                    <h3 className="text-xl font-black text-zinc-900">Editar IVC</h3>
