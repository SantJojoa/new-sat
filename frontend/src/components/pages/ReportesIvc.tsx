                        ...
                        <div className="max-w-7xl mx-auto space-y-6 md:space-y-8">
                            ...
                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                                <div>
                                    <h1 className="text-3xl font-black text-zinc-900 tracking-tight flex items-center gap-3">
                                        <BarChart2 className="text-primary" size={32} />Reportes — IVC
                                    </h1>
                                    <p className="text-zinc-500 mt-1">Estadísticas de actividades de Inspección, Vigilancia y Control.</p>
                                </div>
                            ...
                            <div className="bg-white p-5 rounded-2xl border border-zinc-200/80 shadow-sm">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                                    {[
                                        { label: 'Fecha Inicial', value: startDate, set: setStartDate },
                                        { label: 'Fecha Final', value: endDate, set: setEndDate },
                                    ].map(f => (
                            ...
                            <div className="relative">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-6 md:mb-8">
                                    <div className="bg-gradient-to-br from-primary to-indigo-600 p-6 rounded-2xl shadow-md flex items-center gap-5 relative overflow-hidden group">
                                        ...
                                        <div className="z-10">
                                            <p className="text-indigo-100 font-medium text-sm mb-1">Total IVC</p>
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8">
                                            ...
                                            {!data?.topSolicitantes?.length ? (
                                                ...
                                                <ResponsiveContainer width="100%" height="100%">
                                                    <BarChart data={data.topSolicitantes} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                                                        ...
                                                        <Bar dataKey="count" fill="#10b981" radius={[6, 6, 0, 0]} name="IVC" maxBarSize={50} isAnimationActive={false}>
                                    ...
                                    <div className="bg-white p-5 md:p-7 rounded-2xl border border-zinc-200/80 shadow-sm lg:col-span-2">
                                        <div className="flex items-center gap-2 mb-6">
                                            ...
                                            <h3 className="text-lg font-bold text-zinc-800">IVC por Área</h3>
                                        </div>
