        ...
        <div className="bg-bg-light font-display min-h-screen flex h-screen overflow-hidden">
            ...
            <main className="flex-1 min-w-0 flex flex-col overflow-y-auto bg-zinc-50/50 p-4 sm:p-6 lg:p-8">
                ...
                {detailsModal.isOpen && detailsModal.salida && (
                    <DetailModal title="Detalles de la Solicitud" codigo={detailsModal.salida.codigo} onClose={() => setDetailsModal({ isOpen: false, salida: null })} maxWidth="max-w-4xl">
                        <div className="p-8">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="col-span-1 md:col-span-2 space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
                                        ...
                                        <div>
                                            <span className="block text-zinc-500 text-xs uppercase tracking-wider font-semibold mb-2">EAPB ({detailsModal.salida.salida_eapb?.length ?? 0})</span>
                                            <div className="flex flex-wrap gap-1">
                                                {(detailsModal.salida.salida_eapb?.length ?? 0) > 0 ? (
                                                    detailsModal.salida.salida_eapb.map((se: any, idx: number) => (
