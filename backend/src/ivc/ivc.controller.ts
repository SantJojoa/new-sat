...
export class IvcController {
    ...
    getEstadisticas(
        ...
        return this.ivcService.getEstadisticas(req.user, startDate, endDate, areaId, estado);
    }
    ...
    async downloadExcel(
        ...
        const { buffer, filename } = await this.ivcService.exportExcel(req.user, startDate, endDate, areaId, estado);
    ...
    async downloadPdf(
        ...
        const { buffer, filename } = await this.ivcService.exportPdf(req.user, startDate, endDate, areaId, estado);
